...
class MainApp(QMainWindow, ui):
	...
	def exportModule(self):
		...
		b=df.shape[1]
		desktop=os.getlogin()
		writer = pd.ExcelWriter(f'C:\\Users\\{desktop}\\Desktop\\FormData.xlsx', engine='xlsxwriter')
		...
		try:
			writer.save()
			self.ShowMessageBox('Form Saved', 'You Form Successfully Exported To Your Desktop')
